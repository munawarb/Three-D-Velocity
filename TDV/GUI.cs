		...
		public void mainMenu()
		{
			...
			{ //if not ACB
				...
				while (!exitMenu)
				{
					...
					{
						case 0: //start game
							if (Options.mode == Options.Modes.none)
							{ //start flight with no mode selected
								if (!selectMode())
...
"mainmenu_2_6.wav"
			...
			if (Options.mode == Options.Modes.autoPlay)
			{ //player selected autoplay,
